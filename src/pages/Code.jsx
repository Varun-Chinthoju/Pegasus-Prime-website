...
const Code = () => {
  ...
  const PEGASUS_ASCII = `    1  __________                                          __________        .__
    2  \\______   \\ ____   _________    ________ __  ______ \\______   \\_______|__| _____   ____
    3   |     ___// __ \\ / ___\\\\__  \\  /  ___/  |  \\/  ___/  |     ___/\\_  __ \\  |/     \\/ __ \\
    4   |    |   \\  ___// /_/  > __ \\_\\\\___ \\|  |  / \\___ \\   |    |     |  | \\/  |  Y Y  \\  ___/
    5   |____|    \\___  >___  (____  /____  >____//____  >  |____|     |__|  |__|__|_|  /\\___  >
    6                 \\/_____/     \\/     \\/           \\/                             \\/     \\/

    Pegasus Prime (97711V) - A high-performance VEX Robotics team based in Silicon Valley.
    Powered by Nexus Motion Control and Cybercore Architecture.`;
...
and real-time sensor fusion to ensure absolute consistency during autonomous routines.`,
    cybercore: () => `Cybercore is the base class for the Nexus system.
  ...
  return (
    <div className="max-w-7xl mx-auto py-12 px-4">
      ...
      <div className="w-full max-w-5xl mx-auto">
        ...
        <div className="bg-slate-900/80 backdrop-blur-xl rounded-xl overflow-hidden shadow-2xl border border-slate-700 flex flex-col h-[600px]">
          {/* Title Bar */}
            ...
            {history.map((entry, i) => (
              <div key={i} className="mb-2 whitespace-pre-wrap">
                {entry.type === 'input' ? (
                  ...
                  <div className="text-blue-400 mt-1 pl-4 border-l border-slate-800">{entry.text}</div>
                )}
              </div>
            ))}
